...
export default class LintingProvider implements vscode.CodeActionProvider {
    ...
    public activate(subscriptions: vscode.Disposable[]) {
        this.command = vscode.commands.registerCommand(LintingProvider.commandId, this.runCodeAction, this);
    ...
    public provideCodeActions(document: vscode.TextDocument, range: vscode.Range, context: vscode.CodeActionContext, token: vscode.CancellationToken): vscode.Command[] {
        ...
        return [{
            ...
            command: LintingProvider.commandId,
